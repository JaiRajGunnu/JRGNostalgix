          ...
          {todos.map((todo, index) => (
            <li key={todo._id} className="flex justify-between items-center bg-[#27292af7] p-2 rounded hover:opacity-80 transition">
              <label
                ...
                <div
                  className={`w-4 h-4 flex items-center justify-center border-2 mr-3 ml-2 rounded-lg p-[1px] cursor-pointer ${todo.completed ? "bg-blue-500 border-blue-500" : "border-white/50"}`}
                >
